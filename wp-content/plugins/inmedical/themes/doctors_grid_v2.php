...
if ($doctors):
    ...
    ?>
    <div class="iw-medical-doctors doctors-grid doctors-grid-v2">
        <?php if ($show_filter): ?>
        ...
        <?php endif; ?>
        <div class="iw-row">
            <div class="iw-isotope-main isotope doctor-items-grid-v2">
                        ...
                        <div class="info-wrap">
                            ...
                            <div class="info">
                                ...
                                <?php if ($doctor_info->social_links && !empty($doctor_info->social_links)): ?>
                                    <div class="info-social-link">
                                        <ul>
                                            <?php
                                            foreach ($doctor_info->social_links as $social_link) {
												if($social_link['key_value']){
													echo '<li class="' . $social_link['key_title'] . '"><a class="theme-color-hover" href="' . $social_link['key_value'] . '"><i class="fa fa-' . $social_link['key_title'] . '"></i></a></li>';
												}
                                            }
                                            ?>
                                        </ul>

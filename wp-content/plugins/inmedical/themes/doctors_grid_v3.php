<?php if ($doctors):
    ...
    ?>
    <div class="iw-medical-doctors doctors-grid doctors-grid-v3">
        <?php if ($show_filter): ?>
        ...
        <div class="iw-row">
            <div class="iw-isotope-main isotope doctor-items">
                <?php foreach ($doctors['data'] as $d): ?>
                    ...
                    ?>
                    <div class="doctor-item element-item <?php echo implode(' ', $dep_class); ?> iw-col-md-<?php print 12 / $number_column; ?> iw-col-sm-6 iw-col-xs-12" data-category="<?php echo $doctor_info->department[0] ? $doctor_info->department[0]->slug : ''; ?>">
                        <div class="info-wrap">
                            <?php
                                            ...
                                            <ul>
                                                ...
                                                foreach ($doctor_info->social_links as $social_link) {
													if($social_link['key_value']){
														echo '<li class="' . $social_link['key_title'] . '"><a href="' . $social_link['key_value'] . '"><i class="fa fa-' . $social_link['key_title'] . '"></i></a></li>';
													}
                                                }
                                                ?>
                                            </ul>
                            ...
                            <div class="info">
                                ...
                                <?php if (!empty($doctor_info->department)):
                                    $dep_links = array();
                                        ?><div class="doctor-position"><?php
                                            foreach ($doctor_info->departments as $dep):
                                                $dep_links[] = '<a class="theme-color" href="' . get_permalink($dep->id) . '">' . $dep->title . '</a>';
                                            endforeach;
